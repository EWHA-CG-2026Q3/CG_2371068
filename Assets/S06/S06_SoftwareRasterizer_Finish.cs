...
public class S06_SoftwareRasterizer_Finish : MonoBehaviour
{
    ...
    [SerializeField] private Vector2 vertexA = new Vector2(128, 250);
    [SerializeField] private Vector2 vertexB = new Vector2(100, 60);
    [SerializeField] private Vector2 vertexC = new Vector2(150, 60);
    [SerializeField] private Color fillColor = new Color(1f, 0.6f, 0.9f, 1f);
